...
from Utils.DfPrompting.subprocess_run_program import subprocess_run_program
from Utils.DfPrompting.judgeTestcaseType import judge_test_case_type
from Utils.DfPrompting.dynamic_import_module import dynamic_import_module
...
def analyzeResults(source_file ,target_file ,current_time):
    ...
    for item in data:
        ...
        if replyStage1 == "no":
            ...
            # 判断it
            judge_it_file_path = "./Utils/DfPrompting/judge_it/"+filename
