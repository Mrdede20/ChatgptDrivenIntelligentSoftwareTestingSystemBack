Here are the two programs to achieve your intention:
...
Both programs have the same method name 'binary_bfs' and parameter type. The difference between the two programs is in the way the result is returned. The first program returns the result once it is found, whereas the second program stores the result in two Boolean variables and returns the result at the end.